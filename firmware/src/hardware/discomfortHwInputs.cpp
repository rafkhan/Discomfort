...
DiscomfortInput createDiscomfortInputFromHwInputs(float audioInput, DiscomfortHwInputs hwInputs)
{
  ...
  dcInput.setFolderValues(
    getScaledPotInput(hwInputs.foldAmountPot),
    getScaledPotInput(hwInputs.foldOffsetPot),
    getScaledPotInput(hwInputs.foldSymmetryPot)
  );

  dcInput.setClipperValues(
    getScaledPotInput(hwInputs.distParamCPot),
    getScaledPotInput(hwInputs.distParamBPot)
  );
